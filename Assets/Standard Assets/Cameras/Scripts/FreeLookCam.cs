...
namespace UnityStandardAssets.Cameras
{
    public class FreeLookCam : PivotBasedCameraRig
    {
        ...
        [Range(0f, 10f)] [SerializeField] public float m_TurnSpeed = 1.5f;
        ...
        [SerializeField] private float m_HorizontalOffset = 1.5f; // Novo campo para o deslocamento horizontal
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            // Calcula a nova posição com o deslocamento horizontal
            Vector3 targetPosition = m_Target.position;
            targetPosition -= transform.right * m_HorizontalOffset; // Subtrai para deslocar a câmera para a direita
